...
export default function AdminUsersPage() {
    ...
    const getRoleBadge = (role: string) => {
        switch (role) {
            case 'SUPER_ADMIN': return <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-purple-100 text-purple-800 uppercase tracking-wide">Super Admin</span>;
            case 'ADMIN': return <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-800 uppercase tracking-wide">Admin</span>;
            default: return <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-gray-100 text-gray-800 uppercase tracking-wide">User</span>;
        }
    };
        ...
        <div className="space-y-6">
            <div className="flex justify-between items-end">
                <div>
                    ...
                    <p className="text-gray-500 mt-1">Manage user access, roles, and organization details.</p>
                </div>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-[#FAFBFC]">
                        <tr>
                            ...
                            <th scope="col" className="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Department & Position</th>
                                ...
                                <tr key={u.id} className="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-[#172B4D] flex items-center gap-1.5">
                                            ...
                                            {u.department?.name || <span className="text-gray-400 italic">No Dept</span>}
                                        </div>
